  ...
  const customers = [
    {
      ...
      contact: "Chen Wei",
      phone: "138-1111-0001",
      email: "chen@customer-a.com",
      address: "Tech Park Building A, Shenzhen, Nanshan District",
      orders: 24,
      totalSales: "¥456,800",
      level: "VIP",
    },
    {
      id: 2,
      name: "CUSTOMER B TRADING",
      contact: "Zhao Li",
      phone: "139-2222-0002",
      email: "zhao@customer-b.com",
      address: "Business Tower B, Hangzhou, Binjiang District",
      orders: 15,
      totalSales: "¥289,500",
      level: "STANDARD",
    },
    {
      ...
      contact: "Liu Yang",
      phone: "136-3333-0003",
      email: "liu@customer-c.com",
      address: "Innovation Center C, Chengdu, High-tech Zone",
      orders: 8,
      totalSales: "¥125,600",
      level: "STANDARD",
    },
    {
      id: 4,
      name: "CUSTOMER D GROUP",
      contact: "Zhou Ming",
      phone: "137-4444-0004",
      email: "zhou@customer-d.com",
      address: "International Tower D, Wuhan, Jianghan District",
      orders: 32,
      totalSales: "¥678,900",
      level: "VIP",
    },
          ...
          <div key={customer.id} className="figma-card p-6">
            ...
            <div className="border-t border-black/10 pt-4 grid grid-cols-2 gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-lg font-heading text-black" style={{ fontWeight: 540 }}>{customer.totalSales}</p>
              </div>
            </div>
          </div>
        ))}
